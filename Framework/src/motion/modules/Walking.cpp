...
Walking::Walking()
{
	...
	P_OFFSET = 0;
        A_OFFSET = 0;
        HIP_PITCH_OFFSET = 13.0;  //13
	PERIOD_TIME = 600;
	DSP_RATIO = 0.1;
	STEP_FB_RATIO = 0.28; //0.28
	Z_MOVE_AMPLITUDE = 40;//40 foot height  
        Y_SWAP_AMPLITUDE = 20.0; //swing Right/left
        Z_SWAP_AMPLITUDE = 5;  //5 swing top/down
        PELVIS_OFFSET = 3.0;
        ARM_SWING_GAIN = 1.5;
	...
	m_Joint.SetAngle(JointData::ID_L_SHOULDER_PITCH, 41.313);//41.313
