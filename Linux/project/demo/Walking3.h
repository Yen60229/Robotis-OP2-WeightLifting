...
#ifndef _WALKING3_ENGINE_H_
#define _WALKING3_ENGINE_H_
...
namespace Robot
{
	class Walking3 : public MotionModule
	{
	public:
		enum
		{
	...
	private:
		static Walking3* m_UniqueInstance;
	...
	public:
		...
		static Walking3* GetInstance() { return m_UniqueInstance; }
