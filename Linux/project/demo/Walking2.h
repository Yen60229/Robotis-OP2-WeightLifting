...
#ifndef _WALKING2_ENGINE_H_
#define _WALKING2_ENGINE_H_
...
#define WALKING_SECTION "Walking2 Config"
#define INVALID_VALUE   -1024.0

namespace Robot
{
	class Walking2 : public MotionModule
	{
	public:
		enum
		{
	...
	private:
		static Walking2* m_UniqueInstance;
	...
	public:
		...
		static Walking2* GetInstance() { return m_UniqueInstance; }
